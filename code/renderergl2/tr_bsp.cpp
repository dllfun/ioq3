...
static	void R_LoadLightmaps( lump_t *l, lump_t *surfs ) {
	imgFlags_t  imgFlags = (imgFlags_t)(IMGFLAG_NOLIGHTSCALE | IMGFLAG_NO_COMPRESSION | IMGFLAG_CLAMPTOEDGE);
	byte		*buf, *buf_p;
	dsurface_t  *surf;
	int			len;
	byte		*image;
...
{
	int i;
	imgFlags_t flags = (imgFlags_t)(IMGFLAG_CLAMPTOEDGE | IMGFLAG_MIPMAP | IMGFLAG_NOLIGHTSCALE | IMGFLAG_CUBEMAP);
...
{
	int i, j;
	imgFlags_t flags = (imgFlags_t)(IMGFLAG_NO_COMPRESSION | IMGFLAG_CLAMPTOEDGE | IMGFLAG_MIPMAP | IMGFLAG_NOLIGHTSCALE | IMGFLAG_CUBEMAP);
