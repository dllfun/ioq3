...
intptr_t SV_GameSystemCalls( intptr_t *args ) {
	...
	case G_TRACE:
		SV_Trace((trace_t*)VMA(1), (const vec_t*)VMA(2), (vec_t*)VMA(3), (vec_t*)VMA(4), (vec_t*)VMA(5), args[6], args[7], /*int capsule*/ qfalse );
		return 0;
	case G_TRACECAPSULE:
		SV_Trace( (trace_t*)VMA(1), (const vec_t*)VMA(2), (vec_t*)VMA(3), (vec_t*)VMA(4), (vec_t*)VMA(5), args[6], args[7], /*int capsule*/ qtrue );
		return 0;
	...
	case TRAP_STRNCPY:
		strncpy( (char*)VMA(1), (char const*)VMA(2), args[3] );
		return args[1];
